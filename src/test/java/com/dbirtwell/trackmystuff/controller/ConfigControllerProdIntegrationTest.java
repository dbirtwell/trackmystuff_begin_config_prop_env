...
public class ConfigControllerProdIntegrationTest {
	...
	public void configControllerHomeTest() throws Exception {
		String responseStringPiece = "Current Active Profile: prod";
	...
	public void configControllerMessageTest() throws Exception {
		...
		// <200,{"message":"\"Message from Production Properties\""},{Content-Type=[application/json;charset=UTF-8], Transfer-Encoding=[chunked], Date=[Fri, 27 Apr 2018 16:07:01 GMT]}>
		String responseStringPiece = "Message from Production Properties";
